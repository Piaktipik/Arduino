  ...
  switch (POSICION) {
    ...
    case 1:
     ...
     default:
      ...
      lcd.print("                    ");
      if (menu == 3){
        if (boton == 1){boton=0; menu = 1;} // guardo y regreso al sub menu
      }
  }
  
  if (menu == 3){
    if (boton == 2){boton=0; valor = -1;}
    if (boton == 3){boton=0; valor = 1;}
    if (boton == 1){boton=0; menu = 2;} //regreso al sub menu
  }
