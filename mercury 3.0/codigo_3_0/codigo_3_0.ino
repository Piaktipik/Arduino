...
//int dist_maxi_fron = 50;       // distancia maxima frontal
//int dist_mini_late = 60;       // distancia minima lateral
...
void loop() {
  ...
  // ------------------------------------ sigo objetos cercanos ------------------------------------  
//  obstaculo = false; // empiezo diciendo que no hay obstaculos
//  // frontal
//  if(medi_dist_ultr_fron < dist_mini_fron) {atras();obstaculo = true;}
//  // derecho
//  if(medi_dist_ultr_dere < dist_mini_late && !obstaculo) {derecha();obstaculo = true;}
//  // izquierdo
//  if(medi_dist_ultr_izqu < dist_mini_late && !obstaculo) {izquierda();obstaculo = true;}
//  // frontal
//  if(medi_dist_ultr_fron > dist_maxi_fron && !obstaculo) {adelante();obstaculo = true;}
