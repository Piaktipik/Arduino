...
void FreeSixIMU::begin() {
  begin(FIMU_ACC_ADDR, FIMU_ITG3200_DEF_ADDR, false);
}

void FreeSixIMU::begin(bool fastmode) {
  begin(FIMU_ACC_ADDR, FIMU_ITG3200_DEF_ADDR, fastmode);
}

void FreeSixIMU::begin(int acc_addr, int gyro_addr, bool fastmode) {
  delay(5);
