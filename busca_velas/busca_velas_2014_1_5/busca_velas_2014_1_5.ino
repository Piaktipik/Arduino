...
int rlinea = 5000;                // defino el timepo de espera de los sensores -------------------------------------------------------------------------- referencia linea ------------------------------------
...
void loop() {
  ...
  if (veo_line_fren && !apag_vela){
    ...
    atras();delayy(200);          // retrocedo ya que la linea esta de frente
    if(cont_line_dere > cont_line_izqu){izquierda();}else{derecha();}
    delayy(100);      // escapo para el lado con al cual tenga menos sensores en alto 
  }
