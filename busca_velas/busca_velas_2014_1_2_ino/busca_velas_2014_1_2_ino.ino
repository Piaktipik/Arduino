...
void loop() {
  ...
  if(medi_dist_ultr_izqu < dist_mini_late) {if(apun_vela){atras();delayy(200);}else{derecha();}veo_obst = true;}
    ...
    // frontal
  if(medi_dist_ultr_fron < dist_mini_fron) {if(medi_dist_ultr_dere <= medi_dist_ultr_izqu){izquierda();}else{derecha();} veo_obst = true;}
  ...
  if (cont_vela < 1){}//dist_mini_fron = 30;dist_mini_late = 30; ruid_vela=10;} 
